...
export interface NFTAuthInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NFTAuth extends BaseContract {
  connect(runner?: ContractRunner | null): NFTAuth;
  waitForDeployment(): Promise<this>;

  interface: NFTAuthInterface;
