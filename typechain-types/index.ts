...
export type { Gift } from "./contracts/Gift";
export { Gift__factory } from "./factories/contracts/Gift__factory";
export type { Lock } from "./contracts/Lock";
export { Lock__factory } from "./factories/contracts/Lock__factory";
export type { ManageGroups } from "./contracts/ManageGroups";
export { ManageGroups__factory } from "./factories/contracts/ManageGroups__factory";
...
export type { NFTAuth } from "./contracts/NFTAuth";
export { NFTAuth__factory } from "./factories/contracts/NFTAuth__factory";
